...
//     <TouchableOpacity
//       onPress={onPress}
//       className="m-2 items-center rounded-[12px] border border-primary    "
//       style={[styles.button, { width, backgroundColor: '#EEE' }]}>
//       <LinearGradient
//         colors={['#FFFFFF', '#D0DFFF']}
//         start={{ x: 0.5, y: 0 }} // Top
//         end={{ x: 0.5, y: 1 }} // Bottom (vertical gradient)
//         style={{
//           padding: 6,
//           borderRadius: 8,
//           borderWidth: 1,
//           borderColor: '#0073FF', // Assuming primary color
//         }}>
//         <Icon size={24} />
//       </LinearGradient>
...
//       <TextBodySecondary
//         text={title}
//         style={{ fontSize: 14, fontWeight: 'semibold', fontFamily: 'nunito' }}
//       />
//     </TouchableOpacity>
//   );
// };
